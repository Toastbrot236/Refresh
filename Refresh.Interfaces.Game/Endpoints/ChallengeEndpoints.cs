...
public class ChallengeEndpoints : EndpointGroup
{
    ...
    [EndpointRateLimit(EndpointBucketName.GameUploadPlayerChallenge)]
    ...
    [EndpointRateLimit(EndpointBucketName.GameGetListOfPlayerChallenges)]
    ...
    [RequireEmailVerified]
    [EndpointRateLimit(EndpointBucketName.GameUploadPlayerChallengeScore)]
    ...
    [MinimumRole(GameUserRole.Restricted)]
    [NullStatusCode(NotFound)]
    [EndpointRateLimit(EndpointBucketName.GameGetSinglePlayerChallengeScore)]
    ...
    [MinimumRole(GameUserRole.Restricted)]
    [NullStatusCode(NotFound)]
    [EndpointRateLimit(EndpointBucketName.GameGetListOfPlayerChallengeScores)]
