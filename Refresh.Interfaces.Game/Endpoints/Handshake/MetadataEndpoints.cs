...
public class MetadataEndpoints : EndpointGroup
{
    ...
    [EndpointRateLimit(EndpointBucketName.GameSyncUserPrivacySettings)]
    ...
    [EndpointRateLimit(EndpointBucketName.GameUploadFriendData)]
    ...
    [MinimumRole(GameUserRole.Restricted)]
    [EndpointRateLimit(EndpointBucketName.GameGetGameConfig)]
