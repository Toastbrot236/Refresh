...
public class AdminReviewApiEndpoints : EndpointGroup
{
        ...
        [DocSummary("The ID of the review to delete")] int reviewId)
    {
        ...
        database.CreateModerationAction(review, ModerationActionType.ReviewDeletion, user, "-");
        ...
        [DocSummary("The ID of the profile comment to delete")] int commentId)
    {
        ...
        database.CreateModerationAction(comment, ModerationActionType.ProfileCommentDeletion, user, "-");
        return new ApiOkResponse();
    }
        ...
        [DocSummary("The ID of the level comment to delete")] int commentId)
    {
        ...
        database.CreateModerationAction(comment, ModerationActionType.LevelCommentDeletion, user, "-");
        return new ApiOkResponse();
    }
    ...
    public ApiOkResponse DeleteProfileCommentsByUuid(RequestContext context, GameDatabaseContext database, GameUser user,
        [DocSummary("The UUID of the user")] string uuid)
    {
        ...
        database.DeleteProfileCommentsPostedByUser(moderatedUser);
        database.CreateModerationAction(moderatedUser, ModerationActionType.ProfileCommentsByUserDeletion, user, "-");
        return new ApiOkResponse();
    }
    ...
    [DocError(typeof(ApiNotFoundError), ApiNotFoundError.UserMissingErrorWhen)]
    public ApiOkResponse DeleteProfileCommentsByUsername(RequestContext context, GameDatabaseContext database, GameUser user,
    ...
    [DocError(typeof(ApiNotFoundError), ApiNotFoundError.UserMissingErrorWhen)]
    public ApiOkResponse DeleteLevelCommentsByUuid(RequestContext context, GameDatabaseContext database, GameUser user,
        [DocSummary("The UUID of the user")] string uuid)
    {
        GameUser? moderatedUser = database.GetUserByUuid(uuid);
        if (moderatedUser == null) return ApiNotFoundError.UserMissingError;

        database.DeleteLevelCommentsPostedByUser(moderatedUser);
        database.CreateModerationAction(moderatedUser, ModerationActionType.LevelCommentsByUserDeletion, user, "-");
        return new ApiOkResponse();
    }
    ...
    [DocError(typeof(ApiNotFoundError), ApiNotFoundError.UserMissingErrorWhen)]
    public ApiOkResponse DeleteLevelCommentsByUsername(RequestContext context, GameDatabaseContext database, GameUser user,
        [DocSummary("The username of the user")] string username)
    {
        GameUser? moderatedUser = database.GetUserByUsername(username);
        if (moderatedUser == null) return ApiNotFoundError.UserMissingError;
    ...
    [DocError(typeof(ApiNotFoundError), ApiNotFoundError.UserMissingErrorWhen)]
    public ApiOkResponse DeleteReviewsPostedByUuid(RequestContext context, GameDatabaseContext database, GameUser user,
        [DocSummary("The UUID of the user")] string uuid)
    {
        GameUser? moderatedUser = database.GetUserByUuid(uuid);
        if (moderatedUser == null) return ApiNotFoundError.UserMissingError;
        
        database.DeleteReviewsPostedByUser(moderatedUser);
        database.CreateModerationAction(moderatedUser, ModerationActionType.ReviewsByUserDeletion, user, "-");
        return new ApiOkResponse();
    }
    ...
    [DocError(typeof(ApiNotFoundError), ApiNotFoundError.UserMissingErrorWhen)]
    public ApiOkResponse DeleteReviewsPostedByUsername(RequestContext context, GameDatabaseContext database, GameUser user,
        [DocSummary("The username of the user")] string username)
    {
        GameUser? moderatedUser = database.GetUserByUsername(username);
        if (moderatedUser == null) return ApiNotFoundError.UserMissingError;
