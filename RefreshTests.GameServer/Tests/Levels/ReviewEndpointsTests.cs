...
public class ReviewEndpointsTests : GameServerTest
{
    ...
    public void DpadRateLevelBoo()
    {
        ...
        Assert.That(context.Database.GetLevelRatingByUser(user1, level), Is.EqualTo(RatingType.Boo));
        Assert.That(context.Database.GetLevelRatingByUser(user2, level), Is.EqualTo(null));
    } 
    ...
    public void DpadRateLevelNeutral()
    {
        ...
        Assert.That(message.StatusCode, Is.EqualTo(OK));
        context.Database.Refresh();
        Assert.That(context.Database.GetLevelRatingByUser(user1, level), Is.EqualTo(RatingType.Neutral));
        Assert.That(context.Database.GetLevelRatingByUser(user2, level), Is.EqualTo(null));
    } 
    ...
    public void DpadRateLevelYay()
    {
        ...
        Assert.That(message.StatusCode, Is.EqualTo(OK));
        context.Database.Refresh();
        Assert.That(context.Database.GetLevelRatingByUser(user1, level), Is.EqualTo(RatingType.Yay));
        Assert.That(context.Database.GetLevelRatingByUser(user2, level), Is.EqualTo(null));
    } 
